...
public class Empleado extends Persona4 {
    ...
    public Empleado(String tipoDocumento, String documento, String nombre, String apellido, String peso, double estatura,
            String edad, String sexo, String cargo, int valorHora, int horasTrabajadas, String departamento) {
